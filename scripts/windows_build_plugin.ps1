...
mkdir build
cd build
cmake -G "Visual Studio 16 2019" -DNUKE_ROOT="C:/Program Files/Nuke12.2v10" -DNuke_INCLUDE_DIR="C:/Program Files/Nuke12.2v10/include" -DOIDN_ROOT="C:/oidn-1.4.2.x64.vc14.windows" -DCMAKE_VERBOSE_MAKEFILE=ON -DCMAKE_BUILD_TYPE=Release ..
