...
mkdir build
cd build
cmake -G "Visual Studio 16 2019" -DNUKE_ROOT="C:/Program Files/Nuke12.2v10" -DOIDN_ROOT="C:/oidn-1.4.2.x64.vc14.windows" -DOpenImageDenoise_INCLUDE_DIR="C:/oidn-1.4.2.x64.vc14.windows/include" -DOpenImageDenoise_LIBRARIES="C:/oidn-1.4.2.x64.vc14.windows/lib/OpenImageDenoise.lib" -DCMAKE_VERBOSE_MAKEFILE=ON -DCMAKE_BUILD_TYPE=Release ..
