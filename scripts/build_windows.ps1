...
mkdir build
cd build
cmake -G "Visual Studio 16 2019" -DNuke_INCLUDE_DIR="C:\Program Files\Nuke12.2v10\include" -DOPENIMAGEDENOISE_ROOT_DIR="C:\oidn-1.4.2.x64.vc14.windows" -DOPENIMAGEDENOISE_INCLUDE_DIR="C:\oidn-1.4.2.x64.vc14.windows\include" -DCMAKE_BUILD_TYPE=Release ..
